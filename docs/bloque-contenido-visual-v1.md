...
1. ~~**Proveedor de email**~~ → **EN PAUSA por decisión de producto
   (2026-08-21)**: todo el bloque de dominio propio + email queda como
   pendiente futuro documentado en `docs/pendiente-dominio-y-email.md`.
   No se arranca sin pedido explícito.
2. **Gate de verificación**: ¿sin verificar no se loguea, o entra con
   ...
   **Se decide recién cuando se reabra el punto 1.**
