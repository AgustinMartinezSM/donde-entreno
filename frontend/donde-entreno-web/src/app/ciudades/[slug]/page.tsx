      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-6">
        ...
        <div className="py-8 sm:py-10">
          ...
          <SurfaceCard
            as="section"
            variant="info"
            className="mt-6 overflow-hidden bg-gradient-to-br from-[var(--color-surface)] via-[var(--color-surface-soft)] to-[var(--color-info-soft)] p-5 sm:p-8 lg:p-10"
          >
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {actividades.map((actividad) => (
                  <Link
                    ...
                    className="group flex min-h-full flex-col rounded-[var(--radius-lg)] border border-[var(--color-border-soft)] bg-[var(--color-surface)] p-5 shadow-[0_14px_34px_rgba(12,52,80,0.08)] transition duration-200 ease-out hover:-translate-y-0.5 hover:border-[var(--color-border-accent)] hover:shadow-[0_18px_45px_rgba(12,52,80,0.12)]"
                  >
                    ...
                    <span className="mt-5 w-fit rounded-full bg-[var(--color-success-soft)] px-3 py-1 text-xs font-extrabold text-[var(--color-success)] transition duration-200 ease-out group-hover:bg-[var(--color-brand)] group-hover:text-white">
                      Ver detalle
                    </span>
                  </Link>
                ))}
