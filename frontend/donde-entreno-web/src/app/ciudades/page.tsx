        ...
        <div className="py-8 sm:py-10">
          ...
          >
            ...
            <h1 className="mt-3 max-w-3xl text-4xl font-extrabold leading-tight text-[var(--color-primary)] sm:text-5xl">
              Elegí tu ciudad y encontrá opciones reales para entrenar cerca
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-7 text-[var(--color-muted)] sm:text-lg">
              DondeEntreno organiza actividades por ciudad para que puedas
              descubrir clubes, clases, profes y espacios deportivos sin perder
              tiempo.
            </p>
          </SurfaceCard>
            ...
            {huboError ? (
              ...
              <>
                {ciudadUnica ? (
                  <StatusMessage
                    variant="info"
                    title={`Estamos empezando por ${ciudadUnica.nombre}`}
                    className="mb-6 p-5"
                  >
                    <p>
                      Pronto vamos a sumar nuevas ciudades. Mientras tanto,
                      podés explorar propuestas reales para entrenar cerca.
                    </p>
                  </StatusMessage>
                ) : null}
                  ...
                  {ciudades.map((ciudad) => (
                    ...
                    >
                      ...
                      <p className="mt-2 flex-1 text-sm leading-6 text-[var(--color-muted)]">
                        Entrá a {ciudad.nombre} para ver actividades, clubes y
                        profes que ya podés explorar por deporte, barrio y
                        nivel.
                      </p>
