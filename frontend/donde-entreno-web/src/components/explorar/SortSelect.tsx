  ...
  return (
    <div className="flex w-full flex-col gap-2 sm:max-w-xs lg:w-72">
      ...
      <select
        ...
        className="min-h-12 w-full rounded-[var(--radius-md)] border border-[var(--color-border-accent)] bg-[var(--color-surface)] px-4 text-sm font-bold text-[var(--color-text)] shadow-sm outline-none transition duration-200 ease-out hover:border-[var(--color-accent)] focus:border-[var(--color-accent)] focus-visible:ring-4 focus-visible:ring-[#4FB3D9]/30"
      >
