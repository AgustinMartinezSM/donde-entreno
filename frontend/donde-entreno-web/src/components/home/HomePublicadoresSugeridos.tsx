    ...
    >
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {publicadores.map((publicador) => (
          <article
            key={publicador.id}
            className="flex h-full flex-col rounded-[20px] border border-[#D9E2EC] bg-white p-5 shadow-[0_8px_24px_rgba(15,61,94,0.07)] transition duration-200 ease-out hover:-translate-y-1 hover:border-[#BFDDEA] hover:shadow-[0_16px_40px_rgba(15,61,94,0.12)]"
          >
            <PublisherIdentity
