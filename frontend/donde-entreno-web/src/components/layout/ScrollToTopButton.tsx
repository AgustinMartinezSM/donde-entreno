  ...
  return (
    ...
    */
    <button
      ...
      className="fixed bottom-[calc(5.75rem+env(safe-area-inset-bottom))] right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full border-2 border-[var(--color-secondary)] bg-[var(--color-primary)] text-xl font-extrabold text-[var(--color-secondary)] shadow-[0_12px_30px_rgba(15,61,94,0.28)] ring-4 ring-[#2EB872]/15 transition hover:-translate-y-1 hover:scale-105 active:scale-95 lg:bottom-5 lg:right-5 lg:z-50"
    >
      ↑
    </button>
  );
