...
export function PublishAccessGate() {
  ...
  if (status === "guest" || !rolActual) {
    return (
      <PublicarGateCard
        ...
        description="Ingresá con tu cuenta o creá un perfil publicador para enviar actividades a revisión."
        actions={
          <>
            <AppLinkButton
  ...
  if (esRolPublicador(rolActual)) {
    return (
      <PublicarGateCard
        ...
        description="Así podemos asociar el envío a tu perfil y mostrarte el seguimiento en tus solicitudes."
        actions={
          <>
            <AppLinkButton
  ...
  if (esRolAdmin(rolActual)) {
    return (
      <PublicarGateCard
        ...
        description="Para revisar solicitudes y gestionar el panel interno, continuá desde el panel admin."
        actions={
  ...
  return (
    <PublicarGateCard
      ...
      description="Tu cuenta actual sirve para usar DondeEntreno como usuario. Para enviar actividades a revisión, creá un perfil publicador."
      actions={
...
function PublicarGateCard({
  ...
  return (
    <SurfaceCard className="mt-6 overflow-hidden p-6 sm:p-8">
