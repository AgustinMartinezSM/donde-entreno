  ...
  return (
    ...
    >
      ...
      {abierto ? (
        <div
          id={idPanel}
          className={`absolute top-[calc(100%+0.5rem)] z-50 min-w-56 overflow-hidden rounded-[18px] border border-[#DDEAF3] bg-white p-2 shadow-[0_22px_55px_rgba(12,52,80,0.18)] ${
